...
<section class="content-header" style="background-color:#dcedc8">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>TẠO LOẠI HỒ SƠ</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('loaihoso.index')}}">Home</a></li>
                    <li class="breadcrumb-item active"><a href="{{route('loaihoso.index')}}">Loại hồ sơ</a> </li>
                    <li class="breadcrumb-item active">Tạo loại hồ sơ</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                    ...
                    <form role="form" action="{{route('loaihoso.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="mavitri" placeholder="Mã loại hồ sơ"
                                    name="maloai" value="{{old('maloai')}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tên loại hồ sơ</label>
                                <input type="text" class="form-control" id="sotu" placeholder="Tên loại hồ sơ"
