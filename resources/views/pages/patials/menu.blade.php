            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item has-treeview">
                    <a href="#" class="nav-link">
                        <img src="{{Auth::user()->avatar}}" class="img-circle elevation-2" width="50px"
                            alt="User Image">
                        <p>
                            {{Auth::user()->hoten}}
              ...
              <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('users.index')}}"
                                class="nav-link {{Request::is('users') || Request::is('/') ? 'active' : '' }}">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('permissions.index')}}"
                                class="nav-link {{Request::is('permissions/index') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('chinhanh.index')}}"
                                class="nav-link {{Request::is('chinhanh/index') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Chi Nhánh</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('chinhanh.create')}}"
                                class="nav-link {{Request::is('chinhanh/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('loaihoso.index')}}"
                                class="nav-link {{Request::is('loaihoso/index') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Loại Hồ Sơ</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('loaihoso.create')}}"
                                class="nav-link {{Request::is('loaihoso/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Create Loại Hồ Sơ</p>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('chucvu.index')}}"
                                class="nav-link {{Request::is('chucvu/index') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Chức Vụ</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('chucvu.create')}}"
                                class="nav-link {{Request::is('chucvu/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Create Chức Vụ</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('vitri.index')}}"
                                class="nav-link {{Request::is('vitri/index') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Vị Trí</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('vitri.create')}}"
                                class="nav-link {{Request::is('vitri/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Create Vị Trí</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('phongban.index')}}"
                                class="nav-link {{Request::is('phongban/index') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Phòng Ban</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('phongban.create')}}"
                                class="nav-link {{Request::is('phongban/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('loaiphong.index')}}"
                                class="nav-link {{Request::is('loaiphong/index') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Phòng Ban - Loại Hồ Sơ</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('loaiphong.create')}}"
                                class="nav-link {{Request::is('loaiphong/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="" class="nav-link {{Request::is('vitri/index') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Tra cứu hồ sơ</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link {{Request::is('vitri/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Tra cứu văn bản đến - đi</p>
                            </a>
                        </li>
                    </ul>
                </li>
